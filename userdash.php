...
<body id="userdash">
	<div class="container-fluid">
		...
		<div class="card" style="width:650px; background-color: #fff;padding: 20px;margin-top: 30px;margin-left: 280px;margin-bottom: 50px;" id="send">
			...
			<div class="card-body">
					...
					<form action="sendTicket.php" method="POST" >
						<div class="form-group row">
							<label for="requestor" class="col-md-2 col-form-label">Requestor</label>
							<div class="col-md-10">
							<input type="text" name="request" id="requestor" class="form-control" placeholder='<?php echo "$email";?>' readonly>
							</div>
						</div>
