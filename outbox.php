...
$query = "SELECT * FROM md_tickets WHERE email = '$email' ORDER BY id DESC";
 ...
 ?>
   ...
   <div class="listTicket" >
     <ul class="nav flex-column">
               ...
               <li class="nav-item" onclick="showMessages();">
                  <div class="row">
                     <div class="col-md-4">
  ...
  <div class="card">
     <div class="card-body">
         <p style="padding: 2px;margin: 2px; font-size: 13px;">  Click here to &nbsp<a href="#" >Resend</a></p>
     </div>
  </div>
